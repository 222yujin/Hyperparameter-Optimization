...
output_file = 'C:/Users/yujin/Desktop/work/result/adaboost_random_search_results.xlsx'
...
for filename in os.listdir(folder_path):
    if filename.endswith('.csv'):
        ...
        # 랜덤 서치 수행
        random_search = RandomizedSearchCV(estimator=adaboost, param_distributions=param_distributions, n_iter=30, cv=5, n_jobs=-1, verbose=2, scoring='f1', random_state=42)
