...
output_file = 'C:/Users/yujin/Desktop/work/result/xgboost_random_search_results.xlsx'
...
for filename in os.listdir(folder_path):
    if filename.endswith('.csv'):
        ...
        # XGBoost 모델 초기화 및 하이퍼파라미터 랜덤 서치 설정
        ...
        # 랜덤 서치 수행
        random_search = RandomizedSearchCV(estimator=xgb, param_distributions=param_distributions, n_iter=30, cv=5, n_jobs=-1, verbose=2, scoring='f1', random_state=42)
