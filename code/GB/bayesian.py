...
# 베이지안 최적화 수행
bayes_search = BayesSearchCV(estimator=gbm, search_spaces=param_distributions, n_iter=30, cv=5, n_jobs=-1, verbose=2, scoring='f1', random_state=42)
...
# 최적의 모델로 예측 수행
best_gbm = bayes_search.best_estimator_
...
# 엑셀 파일에 결과 저장
output_file = 'C:/Users/yujin/Desktop/work/result/gradient_boosting_bayesian_search_results.xlsx'
