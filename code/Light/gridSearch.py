...
output_file = 'C:/Users/yujin/Desktop/work/result/lightgbm_grid_search_results.xlsx'
...
for filename in os.listdir(folder_path):
    if filename.endswith('.csv'):
        ...
        # 그리드 서치 수행
        grid_search = GridSearchCV(estimator=lgbm, param_grid=param_grid, cv=5, n_jobs=-1, verbose=2, scoring='f1')
