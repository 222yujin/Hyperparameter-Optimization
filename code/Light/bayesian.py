...
output_file = 'C:/Users/yujin/Desktop/work/result/lightgbm_bayesian_search_results.xlsx'
...
for filename in os.listdir(folder_path):
    if filename.endswith('.csv'):
        ...
        # 베이지안 서치 수행
        bayes_search = BayesSearchCV(estimator=lgbm, search_spaces=param_space, n_iter=30, cv=5, n_jobs=-1, verbose=2, scoring='f1', random_state=42)
