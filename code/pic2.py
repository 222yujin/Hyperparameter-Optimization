...
# Load the data from the provided table (assuming it's pasted as text in a consistent format)
data = {
...
sns.barplot(x='Model', y='Accuracy', hue='Optimization Method', data=df)
