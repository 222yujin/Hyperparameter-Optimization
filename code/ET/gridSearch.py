...
# 그리드 서치 수행
grid_search = GridSearchCV(estimator=et, param_grid=param_grid, cv=5, n_jobs=-1, verbose=2, scoring='f1')
...
y_pred_proba = best_et.predict_proba(X_test)[:, 1]  # 양성 클래스(1)의 확률값 사용
